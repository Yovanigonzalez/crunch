...
<head>
    ...
    <title>Pollo Crunch | Contacto</title>
...
<div>
    <img id="fullWidthImage" src="img/paseo.jpg" alt="Descripción de la imagen">
</div>
    <!-- SVG -->
    ...
    <div class="color-section container">
        ...
        <div class="column">
            <p>¡Bienvenidos a Crunch Chicken, donde la magia de nuestro Crunch transforma cada bocado en una explosión de sabor que no podrás olvidar! En el corazón de Tehuacán, Puebla, somos los creadores de una experiencia gastronómica única que fusiona la pasión por la calidad con la comodidad de lo delicioso.</p>
            <br>
            <p>Imagina pollo crujiente, dorado a la perfección, con un toque secreto que hace que cada mordisco sea una fiesta en tu paladar. En Crunch Chicken, nos esforzamos por elevar el estándar de lo que conoces sobre la comida rápida. Nuestros platillos no solo son una deliciosa indulgencia, ¡son un viaje emocionante para tus sentidos!</p>
        </div>
...
<div class="new-section-two-columns container">
    ...
    <p>Teléfono: <a href="tel:2383922977" style="color: #000;"><i class="bi bi-phone"></i> 2383922977</a></p>
    <p>WhatsApp: <a href="https://wa.me/2383922977?text=Hola%20Crunchicken,%20quiero%20obtener%20información" style="color: #000;"><i class="bi bi-whatsapp"></i> 2383922977</a></p>
    <p>Correo Electrónico: <a href="mailto:CrunchickenTeh@Outlook.com" style="color: #000;"><i class="bi bi-envelope"></i> CrunchickenTeh@Outlook.com</a></p>
    <p>¡En Crunch Chicken, cada contacto es una oportunidad para compartir la delicia!</p>
</div>
