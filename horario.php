...
<head>
    ...
    @media only screen and (max-width: 768px) {
        ...
        .horario {
            margin-top: 20px; /* Añade espacio entre .icono y .horario en pantallas pequeñas */
        }
    }
</style>
...
<div class="container">
    ...
    <div class="horario" id="horario">
        ...
        <br>
        <p><strong>Lunes a Domingo:</strong> 11:00 am - 6:00 pm</p>
        <p id="estado"></p>
        ...
        <script>
            ...
            if (diaActual >= 1 && diaActual <= 7 && horaActual >= horarioInicio && horaActual < horarioFin) {
                ...
                document.getElementById('estado').textContent = 'Por el momento el establecimiento de Crunch Chicken Tehuacán se encuentra cerrado';
